...
public class SalesInvoiceRaw_TokenResponse {
    ...
    private List<SalesInvoiceRaw_ItemPayments> payments = null;

    public List<SalesInvoiceRaw_ItemPayments> getPayments() {
        return payments;
    }

    public void setPayments(List<SalesInvoiceRaw_ItemPayments> payments) {
